      ...
      <Wrapper>
        ...
        <Grid fluid>
          <Row className="more-details">
            {this.state.occurrence.basisOfRecord && <Col md={6} className="details-title">Base del registro</Col>}
            {this.state.occurrence.basisOfRecord && <Col md={6}>{this.state.occurrence.basisOfRecord}</Col>}
            {this.state.occurrence.institutionCode && <Col md={6} className="details-title">Código de la institución</Col>}
            {this.state.occurrence.institutionCode && <Col md={6}>{this.state.occurrence.institutionCode}</Col>}
            {this.state.occurrence.collectionCode && <Col md={6} className="details-title">Código de la colección</Col>}
            {this.state.occurrence.collectionCode && <Col md={6}>{this.state.occurrence.collectionCode}</Col>}
            {this.state.occurrence.type && <Col md={6} className="details-title">Tipo</Col>}
            {this.state.occurrence.type && <Col md={6}>{this.state.occurrence.type}</Col>}
            {this.state.occurrence.modified && <Col md={6} className="details-title">Modificado</Col>}
            {this.state.occurrence.modified && <Col md={6}>{this.state.occurrence.modified}</Col>}
            {this.state.occurrence.language && <Col md={6} className="details-title">Idioma</Col>}
            {this.state.occurrence.language && <Col md={6}>{this.state.occurrence.language}</Col>}
            {this.state.occurrence.license && <Col md={6} className="details-title">Licencia</Col>}
            {this.state.occurrence.license && <Col md={6}>{this.state.occurrence.license}</Col>}
            {this.state.occurrence.rightsHolder && <Col md={6} className="details-title">Titular de los derechos</Col>}
            {this.state.occurrence.rightsHolder && <Col md={6}>{this.state.occurrence.rightsHolder}</Col>}
            {this.state.occurrence.accessRights && <Col md={6} className="details-title">Derechos de acceso</Col>}
            {this.state.occurrence.accessRights && <Col md={6}>{this.state.occurrence.accessRights}</Col>}
            {this.state.occurrence.bibliographicCitation && <Col md={6} className="details-title">Citación bibliográfica</Col>}
            {this.state.occurrence.bibliographicCitation && <Col md={6}>{this.state.occurrence.bibliographicCitation}</Col>}
            {this.state.occurrence.references && <Col md={6} className="details-title">Referencias</Col>}
            {this.state.occurrence.references && <Col md={6}>{this.state.occurrence.references}</Col>}
            {this.state.occurrence.institutionID && <Col md={6} className="details-title">ID de la institución</Col>}
            {this.state.occurrence.institutionID && <Col md={6}>{this.state.occurrence.institutionID}</Col>}
            {this.state.occurrence.collectionID && <Col md={6} className="details-title">ID de la colección</Col>}
            {this.state.occurrence.collectionID && <Col md={6}>{this.state.occurrence.collectionID}</Col>}
            {this.state.occurrence.datasetID && <Col md={6} className="details-title">ID del conjunto de datos</Col>}
            {this.state.occurrence.datasetID && <Col md={6}>{this.state.occurrence.datasetID}</Col>}
            {this.state.occurrence.datasetName && <Col md={6} className="details-title">Nombre del conjunto de datos</Col>}
            {this.state.occurrence.datasetName && <Col md={6}>{this.state.occurrence.datasetName}</Col>}
            {this.state.occurrence.ownerInstitutionCode && <Col md={6} className="details-title">Código de la institución propietaria</Col>}
            {this.state.occurrence.ownerInstitutionCode && <Col md={6}>{this.state.occurrence.ownerInstitutionCode}</Col>}
            {this.state.occurrence.informationWithheld && <Col md={6} className="details-title">Información retenida</Col>}
            {this.state.occurrence.informationWithheld && <Col md={6}>{this.state.occurrence.informationWithheld}</Col>}
            {this.state.occurrence.dataGeneralizations && <Col md={6} className="details-title">Generalización de los datos</Col>}
            {this.state.occurrence.dataGeneralizations && <Col md={6}>{this.state.occurrence.dataGeneralizations}</Col>}
            {this.state.occurrence.dynamicProperties && <Col md={6} className="details-title">Propiedades dinámicas</Col>}
